...
set CLASSPATH=%APP_HOME%\lib\container-service-1.0.0-SNAPSHOT-fat.jar

@rem Execute container-service
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CONTAINER_SERVICE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CONTAINER_SERVICE_EXIT_CONSOLE%" exit 1
exit /b 1
